...
public class PlayerResurector : MonoBehaviour
{
    ...
    private void ReplaceFloorPiece()
    {
        ...
        FloorPiece piece = Instantiate(_resurectionPiece, lastPiece.transform.position, Quaternion.LookRotation(Vector3.Scale(transform.position, new Vector3(1, 0, 1))));
